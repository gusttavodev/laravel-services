...
<div>
      <img
        ...
        :src="$page.props.establishment.data.background_picture"
        alt=""
      />
    </div>
      ...
      <div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
        ...
        >
            <inertia-link
                ...
                method="get"
                as="button"
                class="mx-4 inline-flex justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
            >
               Meu Perfil
            </inertia-link>
            <inertia-link
